  ...
  [
    ...
    new()
    {
      ...
      [
        ...
        new() { ItemType = InventoryItemType.CannonBall, BuyPrice = 26, SellPrice = 21 },
      ],
    ...
    new()
    {
      ...
      [
        ...
        new() { ItemType = InventoryItemType.CannonBall, BuyPrice = 27, SellPrice = 22 },
      ],
    ...
    new()
    {
      ...
      [
        ...
        new() { ItemType = InventoryItemType.CannonBall, BuyPrice = 28, SellPrice = 23 },
      ],
    ...
    new()
    {
      ...
      [
        ...
        new() { ItemType = InventoryItemType.CannonBall, BuyPrice = 22, SellPrice = 18 },
    ...
    new()
    {
      ...
      [
        ...
        new() { ItemType = InventoryItemType.CannonBall, BuyPrice = 24, SellPrice = 19 },
    ...
    new()
    {
      ...
      [
        ...
        new() { ItemType = InventoryItemType.CannonBall, BuyPrice = 26, SellPrice = 22 },
    ...
    new()
    {
      ...
      [
        ...
        new() { ItemType = InventoryItemType.CannonBall, BuyPrice = 21, SellPrice = 17 },
